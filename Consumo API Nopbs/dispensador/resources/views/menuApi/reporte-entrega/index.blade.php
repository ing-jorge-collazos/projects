...
@section('content_header')
    <h1 class="header-title">Reporte entrega</h1>
    <hr>
@stop

@section('content')
{{--<form method="post" enctype="multipart/form-data" action="{{route('get-data')}}">--}}
<form>
    {{ csrf_field() }}
    <div class="row">
        <div class='col-sm-4'>
...
<div class="container-fluid" id="table-content" style="display:none">
    <div class="col-lg-12">
        <div class="card border-primary"><br>
            <div class="card-body">
                <h5 style="" class="title text-center"> <b>Listado de reporte de entrega</b></h5>
                <div class="">
                    ...
                    <hr>
                    <table class="table mb-0" id="table-reporte-entrega" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                                <th class="align-middle" scope="col">Acciones</th>
                                <th class="align-middle" scope="col" title="Identificador">Id</th>
                                <th class="align-middle" scope="col" title="Identificador de Reporte de la Entrega">Id. Reporte Entrega</th>
                                <th class="align-middle" scope="col" title="Fecha de Reporte de la Entrega">Fecha Reporte Entrega</th>
                                <th class="align-middle" scope="col" title="Estado del Reporte de la Entrega(0: Anulado - 1: Activo - 2: Procesado)">Estado Reporte Entrega</th>
                                ...
                                <th class="align-middle" scope="col" title="Estado de Entrega">Estado Entrega</th>
                                ...
                                <th class="align-middle" scope="col" title="Valor Entregado">Valor Entregado</th>
                                <th class="align-middle" scope="col" title="Código Tecnología Entregado">Cod. Tecnología</th>
                ...
                <div class="modal-content">
                    ...
                    <form id="form-prog" style="margin:5%">
                        ...
                        <div class="row">
                            <div class='col-sm-12'>
                                <div class="form-group">
                                    <button class="btn btn-primary btn-block" type="button" id="btn-prog">Registrar</button>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script type="application/javascript">
    ...
    function fillDatatable(formData) {
        dataTable = $('#table-reporte-entrega').DataTable({
            destroy: true
            , serverSide: true
            , processing: true
            , 'language': {
            ...
            , ajax: {
                url: "{{ route('reporte-entrega.data') }}"
                , type: "GET"
                , data: formData
            }
            , "columns": [{
                "render": function(data, type, full, meta) {
                    return full.EstRepEntrega != 0 ? "<input type='button' class='btn btn-sm btn-warning' value='Anular'/>" :
                        "<input type='button' class='btn btn-sm btn-warning' value='Anular' title='La entrega ya fué anulada' disabled/>"
                }
                , "width": "6%"
            }, {
                "data": "ID"
            }, {
                "data": "IDReporteEntrega"
            }, {
                "data": "FecRepEntrega"
            }, {
                "data": "EstRepEntrega"
    ...
    $('#table-entrega').on('click', "input[type='button']", async function() {
